...
setup() {
  ...
  export GITHUB_PATH="$BATS_TEST_TMPDIR/github-path"; : >"$GITHUB_PATH"
}
...
@test "should_install_only_requested_linux_tools" {
  ...
  export INSTALL_CLANG_FORMAT=false INSTALL_CPPCHECK=false INSTALL_SHELLCHECK=true
...
@test "should_report_brew_cppcheck_version_when_requested_on_macos" {
  ...
  export INSTALL_CLANG_FORMAT=false INSTALL_CPPCHECK=true INSTALL_SHELLCHECK=false CPPCHECK_VERSION=2.20.0
