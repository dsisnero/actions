...
setup() { ROOT="$BATS_TEST_TMPDIR/root"; BIN="$ROOT/bin"; mkdir -p "$BIN"; export PATH="$BIN:$PATH" GITHUB_OUTPUT="$ROOT/out" GITHUB_STEP_SUMMARY="$ROOT/summary"; SCRIPT="$BATS_TEST_DIRNAME/../scripts/check.sh"; }
